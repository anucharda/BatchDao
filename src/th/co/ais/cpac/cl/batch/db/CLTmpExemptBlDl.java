...
public class CLTmpExemptBlDl {
	protected final UtilityLogger logger;

	public CLTmpExemptBlDl(UtilityLogger logger) {
		this.logger = logger;
	}
	...
	protected class TruncateExempBlDl extends DBTemplatesInsert<ExecuteResponse, UtilityLogger, DBConnectionPools> {
		...
		protected StringBuilder createSqlProcess() {
			...
			sql.append("Truncate Table CL_TMP_EXEMPT_BL_DL ");
			return sql;
		}
	...
	public class CLTmpExemptBLDlResponse extends DBTemplatesResponse<ArrayList<CLTmpExemptBlDlInfo>> {

		@Override
		protected ArrayList<CLTmpExemptBlDlInfo> createResponse() {
			return new ArrayList<>();
		}

	}

	protected class GetTmpExemptBlDlInfoAction
			extends DBTemplatesExecuteQuery<CLTmpExemptBLDlResponse, UtilityLogger, DBConnectionPools> {
		private BigDecimal maxRecord;

		public GetTmpExemptBlDlInfoAction(UtilityLogger logger) {
			super(logger);
		}

		@Override
		protected CLTmpExemptBLDlResponse createResponse() {
			return new CLTmpExemptBLDlResponse();
		}
		...
		protected void setReturnValue(ResultSet resultSet) throws SQLException {
			CLTmpExemptBlDlInfo temp = new CLTmpExemptBlDlInfo();
		...
		protected CLTmpExemptBLDlResponse execute(BigDecimal maxRecord) {
			this.maxRecord = maxRecord;
			return executeQuery(ConstantsDB.getDBConnectionPools(logger), true);
		}
	}

	public CLTmpExemptBLDlResponse getTmpExemptBLDlInfo(BigDecimal maxRecord, Context context) throws Exception {

		CLTmpExemptBLDlResponse response = new GetTmpExemptBlDlInfoAction(logger).execute(maxRecord);
	...
	protected class UpdateGenFileResultCompleteAction
		...
		protected StringBuilder createSqlProcess() {
			...
			sql.append(" CL_TMP_EXEMPT_BL_DL").append(ConstantsDB.END_LINE);
