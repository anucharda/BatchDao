...
public class CLWaive {
	...
	protected class GetWaiveTreatementInfoInvoiceIDAndAction
		...
		protected StringBuilder createSqlProcess() {
			...
			sql.append(" and A.BATCH_ID = (").append(batchID).append(")").append(ConstantsDB.END_LINE);
			sql.append(" and A.INVOICE_ID = (").append(invoiceID).append(")").append(ConstantsDB.END_LINE);
			return sql;
		}
	...
	protected class UpdateWaiveStatus extends DBTemplatesUpdate<ExecuteResponse, UtilityLogger, DBConnectionPools> {
		...
		protected StringBuilder createSqlProcess() {
			StringBuilder sql = new StringBuilder();
			sql.append("UPDATE dbo.CL_WAIVE ").append(ConstantsDB.END_LINE);
			...
			sql.append(" AND INVOICE_ID   = ").append(invoiceID).append(ConstantsDB.END_LINE);
