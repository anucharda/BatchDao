...
public class CLWriteOff {
	...
	protected class GetWriteOffTreatementInfoByBatch
		...
		protected StringBuilder createSqlProcess() {
			...
			sql.append(" WT.TREATMENT_ID, W.BA_NO,  W.WRITEOFF_TYPE_ID ").append(ConstantsDB.END_LINE);
			sql.append(" FROM dbo.CL_WRITEOFF W ").append(ConstantsDB.END_LINE);
			sql.append(" INNER JOIN dbo.CL_WRITEOFF_TREATMENT WT ").append(ConstantsDB.END_LINE);
			sql.append(" ON W.WRITEOFF_ID = WT.WRITEOFF_ID ").append(ConstantsDB.END_LINE);
			sql.append(" WHERE W.BATCH_ID  = (").append(batchID).append(")").append(ConstantsDB.END_LINE);
			return sql;
		}
